...
from modeling.cheeks_landmarks import main


class TestCheeksLandmarksMain:
    @patch("modeling.cheeks_landmarks.setup_logging")
    @patch("modeling.cheeks_landmarks.hyperparameter_grid_search")
    @patch("modeling.cheeks_landmarks.CHEEKS_LANDMARKS_IN_APEX_CSV", "cheeks_landmarks.csv")
    @patch("modeling.cheeks_landmarks.CHEEKS_LANDMARKS_RUNS_DIR")
    def test_main_execution(self, mock_runs_dir, mock_grid_search, mock_setup_logging):
        ...
        expected_dataset_path = "cheeks_landmarks.csv"
