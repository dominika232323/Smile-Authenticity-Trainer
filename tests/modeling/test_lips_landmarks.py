...
from modeling.lips_landmarks import main


class TestLipsLandmarksMain:
    @patch("modeling.lips_landmarks.setup_logging")
    @patch("modeling.lips_landmarks.hyperparameter_grid_search")
    @patch("modeling.lips_landmarks.LIPS_LANDMARKS_IN_APEX_CSV", "lips_landmarks.csv")
    @patch("modeling.lips_landmarks.LIPS_LANDMARKS_RUNS_DIR")
    def test_main_execution(self, mock_runs_dir, mock_grid_search, mock_setup_logging):
        ...
        expected_dataset_path = "lips_landmarks.csv"
