...
from modeling.lips_features import main


class TestLipsFeaturesMain:
    @patch("modeling.lips_features.setup_logging")
    @patch("modeling.lips_features.hyperparameter_grid_search")
    @patch("modeling.lips_features.ALL_LIP_FEATURES_CSV", "lips.csv")
    @patch("modeling.lips_features.LIPS_RUNS_DIR")
    def test_main_execution(self, mock_runs_dir, mock_grid_search, mock_setup_logging):
        ...
        expected_dataset_path = "lips.csv"
